        ...
        <div className="container">
          <div className="info">
            ...
            <div className="meta">
              ...
              {Socials({ link: pageUrl, text: encodeURIComponent(socialTitle) })}
            </div>
          </div>
          <div className="content">
            {fixed ? (
              <Img fixed={fixed} style={{ display: 'block', margin: '0 auto 20px auto', width: '100%', height:  '300px'  }} />
            ) : (
              ''
            )}
          </div>
  ...
  const Socials = ({ link, text }) => {
    return (
      <span className="social">
        ...
        <a
          href={`https://twitter.com/share?url=${link}&text=${text + ' @tamanyan55'}`}
          target="_blank"
